...
export default function EditSessionPage() {
  ...
  return (
    <div>
      <Breadcrumbs items={[{ label: 'Sessions', href: '/sessions' }, { label: form.name || 'Session' }, { label: 'Edit' }]} />

      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Edit Session</h1>
          <p className="text-sm text-gray-500 mt-1">Update academic session details and terms</p>
        </div>
      </div>
