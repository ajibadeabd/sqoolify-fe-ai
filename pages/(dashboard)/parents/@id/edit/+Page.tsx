  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Update parent information and details</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Form Column */}
        <Card title="Parent Details" className="lg:col-span-2">
              ...
              <div className="space-y-3">
                ...
                {form.relationship && (
                  <div className="p-3 bg-blue-50 rounded-lg">
                    ...
                    <p className="font-medium text-blue-700 text-sm">{form.relationship.charAt(0).toUpperCase() + form.relationship.slice(1)}</p>
                  </div>
                )}
                ...
                <div className="p-3 bg-indigo-50 rounded-lg">
                  ...
                  <p className="font-medium text-indigo-700 text-sm">{children.length} children linked</p>
                </div>
              </div>
            </Card>
          </div>
