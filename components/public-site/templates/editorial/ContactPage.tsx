            ...
            <div className={`grid gap-5 ${[school.address, school.phone, school.email].filter(Boolean).length === 3 ? 'lg:grid-cols-3' : [school.address, school.phone, school.email].filter(Boolean).length === 2 ? 'md:grid-cols-2' : ''}`}>
              {school.address && (
                <a
                  ...
                  className="group relative bg-gray-50 rounded-[2.5rem] p-10 hover:bg-white hover:shadow-2xl hover:shadow-gray-200/60 border border-gray-100 hover:border-gray-200 transition-all duration-500 hover:-translate-y-1 overflow-hidden"
                >
                  ...
                  <div className="w-14 h-14 rounded-[1.25rem] flex items-center justify-center text-white mb-6 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-500" style={{ backgroundColor: pc }}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-500 text-sm mt-8 leading-relaxed">{officeHoursAfterNote}</p>
            </div>

            <div className="relative">
              <div className="rounded-[2.5rem] overflow-hidden shadow-2xl shadow-black/40 border border-white/5">
                <img src={officeHoursImage} alt="School campus" className="w-full h-[420px] object-cover" />
              </div>
              <div className="absolute -bottom-6 -left-6 bg-white rounded-[1.5rem] p-5 shadow-2xl shadow-black/20 border border-gray-100">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-[0.75rem] flex items-center justify-center" style={{ backgroundColor: `${pc}10`, color: pc }}>
      ...
      <section className="px-6 py-28 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">{visitDescription}</p>
          </div>

          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {visitReasons.map((item) => (
              <div key={item.title} className="group bg-gray-50 rounded-[2.5rem] p-8 hover:bg-white hover:shadow-2xl hover:shadow-gray-200/60 border border-gray-100 hover:border-gray-200 transition-all duration-500 hover:-translate-y-1">
                <div className="w-12 h-12 rounded-[1rem] flex items-center justify-center text-white mb-6 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-500" style={{ backgroundColor: pc }}>
