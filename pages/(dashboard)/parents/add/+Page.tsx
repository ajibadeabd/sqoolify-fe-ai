  ...
  return (
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">Add a new parent or guardian</p>
      </div>
              ...
              <div className="space-y-3">
                ...
                {form.relationship && (
                  <div className="p-3 bg-blue-50 rounded-lg">
                    ...
                    <p className="font-medium text-blue-700 text-sm">
                      {form.relationship.charAt(0).toUpperCase() + form.relationship.slice(1)}
                    </p>
                  </div>
                )}
                ...
                {form.occupation && (
                  <div className="p-3 bg-purple-50 rounded-lg">
                    <p className="text-xs text-purple-600 mb-1">Occupation</p>
                    <p className="font-medium text-purple-700 text-sm">{form.occupation}</p>
                  </div>
                )}
                ...
                {form.email && (
                  <div className="p-3 bg-sky-50 rounded-lg">
                    ...
                    <p className="font-medium text-sky-700 text-sm">{form.email}</p>
                  </div>
                )}
                ...
                {form.phone && (
                  <div className="p-3 bg-green-50 rounded-lg">
                    ...
                    <p className="font-medium text-green-700 text-sm">{form.phone}</p>
                  </div>
                )}
                ...
                {form.address && (
                  <div className="p-3 bg-orange-50 rounded-lg">
                    ...
                    <p className="font-medium text-orange-700 text-sm">{form.address}</p>
                  </div>
                )}
                ...
                <div className="p-3 bg-indigo-50 rounded-lg">
                  ...
                  <p className="font-medium text-indigo-700 text-sm">
                    {selectedStudentIds.length > 0
                      ? `${selectedStudentIds.length} children selected`
                      : 'No children selected'}
                  </p>
                </div>

                <div className="p-3 bg-blue-50 rounded-lg">
                  <p className="text-xs text-blue-600 mb-2 font-medium">Tips</p>
                  <ul className="text-xs text-blue-700 space-y-1">
                    <li>A password will be auto-generated for the parent.</li>
                    <li>You can link children now or later from the parent profile.</li>
                    <li>Email address must be unique across all users.</li>
                  </ul>
                </div>
              </div>
            </Card>
